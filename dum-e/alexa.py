...
def handle_session_end_request():
    ...
    speech_output = "Please dont donate me to the community college sir"
    # Setting this to true ends the session and exits the skill.
    should_end_session = True
    return build_response({}, build_speechlet_response(
        card_title, speech_output, None, should_end_session))

def move_intent(intent, session):
    ...
    speech_output = "Moving " + direction + " " + distance
    reprompt_text = "What can i do for you?"
    return build_response(session_attributes, build_speechlet_response(
        card_title, speech_output, reprompt_text, should_end_session))


def action_intent(intent, session):
    ...
    speech_output = "Completing  " + action
    reprompt_text = "What can i do for you?"
    return build_response(session_attributes, build_speechlet_response(
        card_title, speech_output, reprompt_text, should_end_session))
...
def on_intent(intent_request, session):
    ...
    if intent_name == "MoveIntent":
        return move_intent(intent, session)
    elif intent_name == "ActionIntent":
        return action_intent(intent, session)
